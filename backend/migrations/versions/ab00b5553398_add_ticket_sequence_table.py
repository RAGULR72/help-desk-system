"""Add ticket sequence table

Revision ID: ab00b5553398
Revises: 179afab193af
Create Date: 2026-01-02 19:21:07.442125
...
revision: str = 'ab00b5553398'
down_revision: Union[str, Sequence[str], None] = '179afab193af'
...
def upgrade() -> None:
    ...
    op.drop_index(op.f('ix_ticket_sequences_id'), table_name='ticket_sequences')
    ...
    op.add_column('tickets', sa.Column('custom_id', sa.String(), nullable=True))
    op.create_index(op.f('ix_tickets_custom_id'), 'tickets', ['custom_id'], unique=False)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_tickets_custom_id'), table_name='tickets')
    op.drop_column('tickets', 'custom_id')
    ...
    sa.Column('fy_start_month', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('current_fy', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('next_number', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.PrimaryKeyConstraint('id', name=op.f('ticket_sequences_pkey'))
    )
    op.create_index(op.f('ix_ticket_sequences_id'), 'ticket_sequences', ['id'], unique=False)
